...
export class CheckoutComponent implements OnInit {
    ...
    get age() {
        return this.checkoutFormGroup.get('customer.age');
    }

    get sex() {
        return this.checkoutFormGroup.get('customer.sex');
    }
    ...
    onSubmit() {
        ...
        purchase.shippingAddress.country = this.billingAddressCountry;

        //customer
        purchase.customer = this.checkoutFormGroup.controls['customer'].value;
        purchase.firstName= purchase.customer.firstName ;
        purchase.lastName = purchase.customer.lastName;
        purchase.age = purchase.customer.age;
        purchase.sex = purchase.customer.sex;
        purchase.Date = purchase.customer.Date;
        ...
        //if (!this.checkoutFormGroup.invalid && this.displayError.textContent === "") {
            ...
            this.checkoutService.placeOrder(purchase).subscribe({
                ...
                error: err => {
                    ...
                    this.isDisabled = false; // Ensure that isDisabled is set to false on error
                }
            })
