...
export class ProductService {
  ...
  private categoryUrl = 'http://localhost:8080/api/v1/product-categories';
  private searchUrl = 'http://localhost:8080/api/v1/products';

  constructor (private httpClient: HttpClient) { }

  getProductList(theCategoryId: number): Observable<Product[]> {

    const searchUrl = `http://localhost:8080/api/v1/products/category?id=${ theCategoryId }`;
